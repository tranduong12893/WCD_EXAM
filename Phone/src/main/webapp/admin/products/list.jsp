                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <th><%=pr.getId()%></th>
                                        <td><%=pr.getName()%></td>
                                        <td><%=listBrand.get(2).getName()%></td>
                                        <td><%=pr.getPrice()%></td>
                                        <td >
                                        <%=pr.getDescription()%>
                                        </td>
                                        <td>
                                            <a href="/admin/products/detail?id=<%=pr.getId()%>"><i class="fas fa-solid fa-eye"></a>
                                            <a href="/admin/products/delete?id=<%=pr.getId()%>" onclick="return confirm('Are you sure?')"><i class="fas fa-solid fa-trash"></i></i></a>
